    ...
    <html lang="en">
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
            <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css"
                rel="stylesheet" integrit y="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
            ...
            <body>
                ...
                <div class="container">
                    <a class="navbar-brand fw-bold" href="/gd4_x_yyyy">PHP - Yohanes Elang Samudra</a>
            </div>
                </nav>
